...
| -------------------------------------------------------------------*/
    ...
    $d1 = $dir.'/images'; // Relative to domain name
    $d2 = $_SERVER['DOCUMENT_ROOT'] . $d1;
    #echo $d1;
    
    #$_SESSION['RF']['subfolder'] $path = realpath($_SERVER['DOCUMENT_ROOT'].'/nn/uploads/'.$ud);
    $config['img_path'] = '/'.$dir.'/images'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $dir . '/images';
