...
|    |   |   |   |   |- plugin.min.js
*/
preg_match('/^\/([^\/\.]*).*$/i',$_SERVER['PHP_SELF'],$matchd);
$dir='/'.$matchd[1];
#echo 'hey<br>'.print_r($matchd);
    #$subd=addslashes($_SERVER['SCRIPT_NAME']);$subd=explode('/',$subd);
    #echo$dir.'../uploads/';
    #$subfolder=$subd[count($subd)-3];
$config = array(
