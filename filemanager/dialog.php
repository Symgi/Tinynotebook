...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<script>
		...
		Dropzone.options.rfmDropzone = {
			...
			dictFileTooBig: "<?php echo trans('Error_Upload').', Limit:'.$MaxSizeUpload;?>MB",
...
<!-- header div end -->
	...
	<div class="span12">
		...
		<br/>
		<div class="alert alert-error"><?php echo $current_path.$rfm_subfolder.$subdir; ?>There is an error! The upload folder there isn't. Check your config.php file. </div>
		<?php }else{ ?>
